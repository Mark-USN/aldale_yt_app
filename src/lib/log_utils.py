    ...
    *,
    ...
    def _kind_summary(d: Mapping[object, object]) -> str | None:
        ...
        if kind == "video":
            ...
            return f"video {vid!s}{vpart} title={_short(title)} published at={_short(pub)}"
        ...
        if kind == "playlist":
            ...
            pub = d.get("published_at", "")
            cnt = d.get("itemCount", "")
            return f"playlist {pid!s} itemCount={cnt!s} title={_short(title)} published at={_short(pub)}"
        ...
        if kind == "playlist#video":
            ...
            return (
                ...
                f"position={pos!s} title={_short(title)} published at={_short(pub)}"
            )
